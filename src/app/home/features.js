...
export const Sm = () => {
  ...
  return (
    <div
      ref={scope}
      className=" md:hidden text-3xl relative z-10"      
    >
      <h2 className="text-center text-balance leading-tight text-4xl mt-20">
        Explore endless <br /> possiblities
      </h2>

      <div>
        <div className=" space-y-3 px-6">
          <div className="box box-1 w-[full] aspect-[1/1.5] shadow-sm rounded-2xl p-6 bg-secondary-purple text-primary-purple  -top-20 space-y-6 px-6">
          ...
          <div
            className="box box-2 w-full aspect-[1/1.5] shadow-sm  bg-secondary-pink text-primary-pink
             top p-6 rounded-2xl space-y-6 relative"
          >
          ...
          <div
            className="box box-3 w-full aspect-[1/1.5] rounded-2xl shadow-sm bg-secondary-green text-primary-green
             top-28 p-6 space-y-6
            "
          >
          ...
          <div
            className="box box-4  w-full aspect-[1/1.5] rounded-2xl shadow-sm  bg-secondary-yellow text-primary-yellow overflow-hidden
             top-32 p-6
            "
          >
            <div>
          ...
          <div
            className="box box-5 w-full aspect-[1/1.5] rounded-2xl shadow-sm  bg-secondary-orange text-primary-orange
             top-36  p-6 space-y-6
            "
          >
          ...
          <div
            className="box box-6 w-full aspect-[1/1.5] rounded-2xl shadow-sm bg-secondary-blue p-6 space-y-6 overflow-hidden text-primary-blue
             relative"
          >
            <div className="space-y-3">
...
export const Md = () => {
  ...
  return (
    <div>
      <div className="container mx-auto max-w-4xl pt-64 space-y-12 px-6 hidden md:block">
