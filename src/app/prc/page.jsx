...
const Sm = () => {
  ...
  return (
    <div ref={scope} className=" md:hidden text-3xl relative z-10 space-y-12 py-12">
      <h2 className="text-center text-balance leading-tight text-4xl">
        Explore endless <br /> possiblities
      </h2>

      <div className=" space-y-3 px-6 min-h-svh bg-orange-100/90 relative">
        <div className="box sticky top-6 box-1 w-[full] aspect-[1/1.5] shadow-sm rounded-2xl p-6 bg-secondary-purple text-primary-purple space-y-6 px-6">
        ...
        <div
          className="box sticky  box-2 w-full aspect-[1/1.5] shadow-sm  bg-secondary-pink text-primary-pink
             top-12 p-6 rounded-2xl space-y-6 "
        >
        ...
        <div
          className="box sticky top-16 box-3 w-full aspect-[1/1.5] rounded-2xl shadow-sm bg-secondary-green text-primary-green
              p-6 space-y-6
            "
        >
        ...
        <div
          className="box sticky top-20 box-4  w-full aspect-[1/1.5] rounded-2xl shadow-sm  bg-secondary-yellow text-primary-yellow overflow-hidden
              p-6
            "
        >
          <div>
        ...
        <div
          className="box sticky top-24 box-5 w-full aspect-[1/1.5] rounded-2xl shadow-sm  bg-secondary-orange text-primary-orange
             p-6 space-y-6
            "
        >
        ...
        <div
          className="box sticky top-28 box-6 w-full aspect-[1/1.5] rounded-2xl shadow-sm bg-secondary-blue p-6 space-y-6 overflow-hidden text-primary-blue
             "
        >
          <div className="space-y-3">
